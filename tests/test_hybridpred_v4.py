...
class StubBK:
    ...
    def query(self, q, max_dist=1): return [("word", 1)]

class StubCtx:
    def __init__(self): 
        self.freq = {"world": 2}
        self.recent = ["world"]
    def learn(self, txt): pass
    def bias_words(self, ranked): return ranked
    def save(self): pass

class StubRL:
    def get_weights(self): return {"semantic": 0.5, "markov": 0.4, "personal": 0.1}
